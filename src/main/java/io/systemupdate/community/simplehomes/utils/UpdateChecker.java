...
public class UpdateChecker {
    ...
    public UpdateChecker(){
        version = Double.valueOf(SimpleHomes.instance.getDescription().getVersion().split("-")[0]);
        schedulerId = Bukkit.getServer().getScheduler().runTaskTimerAsynchronously(SimpleHomes.instance, new Runnable(){
        ...
        if(version != resourceVersion){
            ...
            try{
                ...
                if(resourceVersion != version){
                    ...
                    SimpleHomes.instance.getLogger().warning("[Update] New update available - Current Version is " + version + " and new update version is " + resourceVersion);
                    SimpleHomes.instance.getLogger().warning("[Update] You can download the update from http://www.spigotmc.org/resources/" + resourceId + "/");
                }else{
